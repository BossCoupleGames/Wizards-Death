...
namespace _Scripts
{
    public class TurretMain: MonoBehaviour,ITakeDamage
    {
        ...
        [SerializeField] private AudioClip towerdeathSound;
        [SerializeField] private float towerDeathVol = 1f;
        [SerializeField] private AudioClip towerHURTSound;
        [SerializeField] private float towerhurtVol = 1f;
        ...
        public void TakeDamage(float damage)
        {
            ...
            {_animator.SetTrigger("Hurt");
                 ...
                 AudioSystem.Instance.PlaySound(towerHURTSound,towerhurtVol);
                 if (currentHealth <= 0)
                            {   AudioSystem.Instance.PlaySound(towerdeathSound,towerDeathVol);
